    ...
    public class CartController : Controller
    {
        ...
        public IActionResult AddToCart(int id, int quantity = 1)
        {
            if (User.Identity == null || !User.Identity.IsAuthenticated)
            {
                ...
                var redirectUrl = Url.Action("AddToCartAndRedirect", "Cart", new { id = id, quantity = quantity, returnUrl = localReturnUrl });
        ...
        // ===========================
        [HttpGet]
        public IActionResult AddToCartAndRedirect(int id, int quantity = 1, string? returnUrl = null)
        {
            if (User.Identity == null || !User.Identity.IsAuthenticated)
            {
                return RedirectToAction("Login", "Account", new { returnUrl = Url.Action("AddToCartAndRedirect", "Cart", new { id = id, quantity = quantity, returnUrl = returnUrl }) });
            }
        ...
        [HttpPost]
        public IActionResult PlaceOrder(string address, string paymentMethod, string? phone = null)
        {
            var cart = GetCart();
            if (!cart.Any())
                return RedirectToAction("Index");
