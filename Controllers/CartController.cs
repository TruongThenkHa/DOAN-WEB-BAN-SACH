...
namespace Book_Store.Controllers
{
    public class CartController : Controller
    {
        ...
        )
        {
            ...
            // MoMo: cart stays, MoMo form is submitted by the frontend JS directly
            // This branch shouldn't be hit from PlaceOrder since MoMo uses its own form,
            // but clear cart here as a safety fallback.
            HttpContext.Session.Remove(GetCartKey());
            return RedirectToAction("Success");
        }
